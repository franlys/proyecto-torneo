...
export function TeamPortalClient({
  ...
  const showDiscordVoice = tournament.discord_integration_enabled && discordGuildId && team.discord_voice_channel_id

  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      {showDiscordVoice && (
        <div className="bg-[#5865F2]/10 border border-[#5865F2]/25 rounded-2xl p-5 space-y-3 shadow-[0_0_15px_rgba(88,101,242,0.1)] animate-in fade-in slide-in-from-top-4 duration-300">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#5865F2]/20 flex items-center justify-center text-white text-xl">
              🔊
            </div>
            <div className="flex-grow min-w-0">
              <h4 className="text-xs font-orbitron font-bold text-white uppercase tracking-wider truncate">Canal de Voz de tu Equipo</h4>
              <p className="text-[10px] text-white/50 leading-normal">
                Tu sala de voz privada está lista en el Discord del streamer. Únete con tu equipo.
              </p>
            </div>
          </div>
          <a 
            ...
            className="flex items-center justify-center gap-2 w-full py-2.5 px-4 rounded-xl bg-[#5865F2] hover:bg-[#5865F2]/90 text-white font-orbitron font-bold text-[11px] uppercase tracking-wider transition-all shadow-[0_4px_12px_rgba(88,101,242,0.3)] hover:shadow-[0_4px_16px_rgba(88,101,242,0.4)] active:scale-[0.98]"
          >
