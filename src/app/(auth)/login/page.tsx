          ...
          <div className="grid grid-cols-2 gap-2.5">
            ...
            <button
              onClick={() => {
                ...
                supabase.auth.signInWithOAuth({ provider: 'google', options: { redirectTo: redirectToUrl } })
              }}
              className="flex items-center justify-center gap-2 py-2.5 px-3 bg-white/5 hover:bg-white/10 border border-white/5 hover:border-white/15 rounded-xl transition-all group"
            ...
            >
              ...
              <span className="text-xs font-semibold text-white/60 group-hover:text-white/90 transition-colors">Google</span>
            </button>
            ...
            <button
              onClick={() => {
                const supabase = createClient()
                const redirectToUrl = `${window.location.origin}/auth/callback${redirectTo ? `?next=${encodeURIComponent(redirectTo)}` : ''}`
                supabase.auth.signInWithOAuth({ provider: 'discord', options: { redirectTo: redirectToUrl } })
              }}
              className="flex items-center justify-center gap-2 py-2.5 px-3 bg-white/5 hover:bg-[#5865F2]/10 border border-white/5 hover:border-[#5865F2]/20 rounded-xl transition-all group"
            ...
            >
              ...
              <span className="text-xs font-semibold text-white/60 group-hover:text-[#5865F2] transition-colors">Discord</span>
            </button>
            ...
            <a
              ...
              title="Iniciar sesión con Kick"
            >
              <svg className="w-4 h-4 shrink-0 text-[#53FC18]" viewBox="0 0 24 24" fill="currentColor">
                <path d="M3 2h4v7.5l5-7.5h5l-6 9 6.5 11H12l-5-8.5V22H3V2z" />
              </svg>
              <span className="text-xs font-semibold text-white/60 group-hover:text-[#53FC18] transition-colors">Kick</span>
            </a>
            ...
            <button
              onClick={() => {
                const supabase = createClient()
                const redirectToUrl = `${window.location.origin}/auth/callback${redirectTo ? `?next=${encodeURIComponent(redirectTo)}` : ''}`
                supabase.auth.signInWithOAuth({ provider: 'facebook', options: { redirectTo: redirectToUrl } })
              }}
              className="flex items-center justify-center gap-2 py-2.5 px-3 bg-white/5 hover:bg-[#1877F2]/10 border border-white/5 hover:border-[#1877F2]/20 rounded-xl transition-all group"
            ...
            >
              ...
              <span className="text-xs font-semibold text-white/60 group-hover:text-[#1877F2] transition-colors">Facebook</span>
            </button>
          </div>
